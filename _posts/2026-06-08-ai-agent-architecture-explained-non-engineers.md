...
faq:
  ...
  - q: "How long does it take to build an AI agent?"
    a: "A focused first agent typically takes 6 to 12 weeks from scoping to production for a team-scale use case, depending on integration complexity and security review requirements."
  - q: "What does a custom AI agent cost?"
    a: "Expect $40k to $250k for a team-scale first agent, depending on the number of integrations, depth of evaluation testing, and security review requirements."
---
...
A focused first agent typically takes 6 to 12 weeks from scoping to production for a team-scale use case. That range reflects real variation: more integrations, more complex data environments, and stricter security requirements all extend the timeline. A well-scoped, single-workflow agent with clean data access sits closer to 6 weeks.
...
Expect $40k to $250k for a team-scale first agent, depending on the number of integrations required, the depth of evaluation and testing, and security review requirements. Organizations in regulated industries or with complex data governance needs sit toward the higher end. A well-scoped internal tool with clean API access and a single workflow can come in closer to the floor.
